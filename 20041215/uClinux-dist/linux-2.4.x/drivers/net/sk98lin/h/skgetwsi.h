...
#define C_PLUS_15		1.15
#define C_PLUS_10		1.10
#define C_PLUS_5		1.05
#define C_MINUS_5		0.95
#define C_MINUS_10		0.90
#define C_MINUS_15		0.85
...
/*
 * ASIC Core 1V2 voltage (YUKON-2 only)
 */
#define	SK_SEN_CORE_1V2_VAL		1300	/* Voltage ASIC Core 1.3 Volt */

#define	SK_SEN_CORE_1V2_HIGH_ERR	(SK_I32)(SK_SEN_CORE_1V2_VAL * C_PLUS_15)
#define	SK_SEN_CORE_1V2_HIGH_WARN	(SK_I32)(SK_SEN_CORE_1V2_VAL * C_PLUS_10)
