...
extern ledmap_t	ads5282_std;
extern leddef_t	ads5282_def;
...
extern ledmap_t	montejade_std;
extern leddef_t	montejade_def;
static void ledman_initarch(void);
...
extern ledmap_t	ivpn_std;
extern leddef_t	ivpn_def;
static void ledman_initarch(void);
static void ivpn_set(unsigned long bits);
#endif

#ifdef CONFIG_ARCH_KS8695
extern ledmap_t	lite3_std;
extern leddef_t	lite3_def;
static void ledman_initarch(void);
static void lite3_set(unsigned long bits);
#endif

#ifdef CONFIG_ARCH_EP9312
extern ledmap_t	ipd_std;
extern leddef_t	ipd_def;
static void ledman_initarch(void);
...
/*
 *	Here is the definition of the LED's on the CyberGuard/SG565,
 *	as per the labels next to them.
 *
...
/*
 *	Here is the definition of the LED's on the SnapGear/SE4000 and
 *	CyberGuard/SG560/SG580 circuit boards, as per the labels next to them.
 *	LED D7 is not visible on the front panel, so not much point using it...
 *
...
/****************************************************************************/
#endif /* CONFIG_ARCH_SE4000 || CONFIG_MACH_ESS710 || CONFIG_MACH_SG560 || CONFIG_MACH_SG580 || CONFIG_MACH_SG565 */
/****************************************************************************/
/****************************************************************************/
